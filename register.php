...
<head>
  ...
  <title>Register | Reliable Socials</title>
...
<body class="min-h-screen bg-[#f4f8ff] text-slate-900">
  <div class="relative min-h-screen overflow-hidden">
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_15%_20%,_rgba(37,99,235,0.16),_transparent_40%),radial-gradient(circle_at_90%_70%,_rgba(14,165,233,0.18),_transparent_42%),linear-gradient(180deg,_#f8fbff_0%,_#eef6ff_100%)]"></div>
    ...
    <main class="relative mx-auto flex min-h-screen w-full max-w-7xl items-center justify-center px-5 py-0 lg:px-10">
      <section class="w-full max-w-3xl rounded-[32px] border border-blue-100 bg-white/95 p-7 shadow-[0_30px_90px_rgba(37,99,235,0.16)] backdrop-blur sm:p-10">
        ...
        <form id="registerForm" class="mt-8 grid gap-5 sm:grid-cols-2">
          ...
          <button type="submit" class="sm:col-span-2 h-12 w-full rounded-xl bg-blue-600 text-sm font-extrabold text-white shadow-[0_16px_36px_rgba(37,99,235,0.3)] transition hover:bg-blue-700">Create Account</button>
        </form>
