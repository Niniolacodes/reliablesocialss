...
<head>
  ...
  <title>Become a Reseller | Reliable Socials</title>
...
<div class="social-boost-menu ml-5 mt-1 hidden space-y-1 text-[13px] font-semibold text-slate-300">
  ...
  <div class="account-settings-menu ml-5 mt-1 hidden space-y-1 text-[13px] font-semibold text-slate-300">
    ...
    <main class="px-4 pb-4 sm:px-6 lg:h-screen lg:overflow-y-auto lg:px-8 lg:pb-8">
      <header class="sticky top-0 z-20 -mx-4 mb-3 flex items-center justify-between border-b border-slate-200 bg-white/95 px-4 py-3 backdrop-blur sm:-mx-6 sm:px-6 lg:hidden">
        ...
        <p class="text-sm font-extrabold">Reseller Plans</p>
      ...
      <header class="mb-5 hidden items-center justify-between rounded-2xl border border-slate-200 bg-white px-4 py-4 shadow-sm sm:px-6 lg:flex">
        <div><p class="text-xs font-bold uppercase tracking-[0.16em] text-blue-600">Reliable Socials</p><h1 class="mt-1 text-xl font-extrabold sm:text-2xl">Become a Reseller</h1></div>
      </header>

      <section class="mb-5 rounded-3xl border border-slate-200 bg-gradient-to-r from-blue-700 via-blue-600 to-cyan-500 p-6 text-white shadow-[0_24px_60px_rgba(30,64,175,0.28)] sm:p-8">
        <p class="text-xs font-black uppercase tracking-[0.18em] text-cyan-100">Reliable Socials Reseller Hub</p>
        <h2 class="mt-3 text-3xl font-black leading-tight sm:text-4xl">Scale faster with monthly reseller plans.</h2>
        <p class="mt-3 max-w-2xl text-sm text-blue-50/95 sm:text-base">Choose your package, unlock discounted order rates, and increase your margin as you grow.</p>
      </section>

      <section class="grid gap-6 md:grid-cols-2">
        <article class="rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_18px_45px_rgba(15,23,42,0.08)]">
          <div class="inline-flex rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-blue-700">Starter Plan</div>
          <h2 class="mt-4 text-4xl font-black text-slate-900">ReliableSocials Plus</h2>
          <p class="mt-7 text-4xl font-black text-slate-900"><span class="text-lg font-bold">&#8358;</span>4,999.99 <span class="text-lg font-bold text-slate-500">/ month</span></p>
          <div class="my-7 h-px bg-slate-200"></div>
          <ul class="space-y-2 text-sm text-slate-600">
            <li>10% off Social Boost orders</li>
            <li>Priority checkout</li>
            <li>Reseller dashboard access</li>
          </ul>
          <button class="mt-8 w-full rounded-xl bg-blue-600 py-3 text-sm font-black uppercase tracking-wide text-white shadow-[0_12px_28px_rgba(37,99,235,0.3)] hover:bg-blue-700">Subscribe</button>
        </article>

        <article class="relative overflow-hidden rounded-3xl border border-blue-200 bg-white p-6 shadow-[0_20px_55px_rgba(37,99,235,0.16)]">
          <div class="absolute right-4 top-4 rounded-full bg-blue-600 px-3 py-1 text-[10px] font-black uppercase tracking-[0.14em] text-white">Most Popular</div>
          <div class="inline-flex rounded-full border border-cyan-200 bg-cyan-50 px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-cyan-700">Growth Plan</div>
          <h2 class="mt-4 text-4xl font-black text-slate-900">ReliableSocials Pro</h2>
          <p class="mt-7 text-4xl font-black text-slate-900"><span class="text-lg font-bold">&#8358;</span>9,999.99 <span class="text-lg font-bold text-slate-500">/ month</span></p>
          <div class="my-7 h-px bg-slate-200"></div>
          <ul class="space-y-2 text-sm text-slate-600">
            <li>20% off Social Boost orders</li>
            <li>Faster fulfillment priority</li>
            <li>Advanced reseller perks</li>
          </ul>
          <button class="mt-8 w-full rounded-xl bg-slate-900 py-3 text-sm font-black uppercase tracking-wide text-white shadow-[0_12px_28px_rgba(15,23,42,0.28)] hover:bg-slate-800">Subscribe</button>
        </article>
      </section>
    </main>
  </div>
